...
function checkHeartbeat(host, port) {
  ...
  let poolInputStream = Cc["@mozilla.org/scriptableinputstream;1"]
  ...
  NetUtil.asyncFetch(inputStream, function(stream, result, request) {
    ...
    let data = NetUtil.readInputStreamToString(stream, inputStream.available());
...
const HB12 = [0x18, 0x03, 0x02, 0x00, 0x03, 0x01, 0x40, 0x00];
// Heartbeat for TLS1.1
const HB11 = [0x18, 0x03, 0x01, 0x00, 0x03, 0x01, 0x40, 0x00];
